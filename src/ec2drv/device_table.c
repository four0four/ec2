...
DEVICE devices[] =
	{{
		...
		0,			// SFRPAGE register address 
		FALSE,			// USB FIFO size
		0,			// Has Cache
		JTAG,			// Debug Mode (JTAG /C2)
		{{0,0},{0,0},{0,0},{0,0}},	// C2 SFRs Breakpoint low addr
		{{0,0},{0,0},{0,0},{0,0}},	// C2 SFRs Breakpoint high addr
	},
	{
		// JTAG
	...
	},
	{
		...
		{{0,0xd2},{0,0xd4},{0,0xd6},{0,0xdd}},	// C2 SFRs Breakpoint low addr
		{{0,0xd3},{0,0xd5},{0,0xd7},{0,0xde}},	// C2 SFRs Breakpoint high addr
	},
	{
		// C2
	...
	},
	{
		...
		0,			// Has Cache
		C2,			// Debug Mode (JTAG /C2)
		{{0,0x85},{0,0xab},{0,0xce},{0,0xd2}},	// C2 SFRs Breakpoint low addr
		{{0,0x86},{0,0xac},{0,0xcf},{0,0xd3}},	// C2 SFRs Breakpoint high addr
	},
	{
		// C2
	...
	},
	{
		...
		0,			// Scratchpad sector size (bytes)
		TRUE,			// Has Pages SFR registers
		0x97,			// SFRPAGE register address 
		FALSE,			// USB FIFO size
		0,			// Has Cache
		C2,			// Debug Mode (JTAG /C2)
		{{0xf,0x85},{0xf,0xab},{0xf,0xce},{0xf,0xd2}},	// C2 SFRs Breakpoint low addr
		{{0xf,0x86},{0xf,0xac},{0xf,0xcf},{0xf,0xd3}},	// C2 SFRs Breakpoint high addr
	},
	{
		// C2
	...
	},
	{
		...
		0,			// Scratchpad sector size (bytes)
		TRUE,			// Has Pages SFR registers
		0xbf,			// SFRPAGE register address 
		1024,			// USB FIFO size
		0,			// Has Cache
		C2,			// Debug Mode (JTAG /C2)
		{{1,0xcc},{1,0xce},{1,0xd4},{1,0xd6}},	// C2 SFRs Breakpoint low addr
		{{1,0xcd},{1,0xcf},{1,0xd5},{1,0xd7}},	// C2 SFRs Breakpoint high addr
	},
	{
		// C2
	...
	{
		// C2
		"C8051F530",	// Device Name
		0x11,			// Device id (Family)
		0x97,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x2000,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F531",	// Device Name
		0x11,			// Device id (Family)
		0x98,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x2000,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F533",	// Device Name
		0x11,			// Device id (Family)
		0x99,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x1000,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F534",	// Device Name
		0x11,			// Device id (Family)
		0x9a,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x1000,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F536",	// Device Name
		0x11,			// Device id (Family)
		0x9b,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x800,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F537",	// Device Name
		0x11,			// Device id (Family)
		0x9c,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x800,			// Flash Size (Marketing number)
		512,			// Flash Sector Size
		0,			// XRAM Size
	...
	{
		// C2
		"C8051F920",	// Device Name
		0x16,			// Device id (Family)
		0xb1,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x8000,			// Flash Size (Marketing number)
		1024,			// Flash Sector Size
		4096,			// XRAM Size
	...
	{
		// C2
		"C8051F921",	// Device Name
		0x16,			// Device id (Family)
		0xb2,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x8000,			// Flash Size (Marketing number)
		1024,			// Flash Sector Size
		4096,			// XRAM Size
	...
	{
		// C2
		"C8051F930",	// Device Name
		0x16,			// Device id (Family)
		0x56,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x10000,			// Flash Size (Marketing number)
		1024,			// Flash Sector Size
		4096,			// XRAM Size
	...
	{
		// C2
		"C8051F931",	// Device Name
		0x16,			// Device id (Family)
		0x57,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x10000,			// Flash Size (Marketing number)
		1024,			// Flash Sector Size
		4096,			// XRAM Size
	...
	},
	{
		// C2
		"SI1021",	// Device Name
		0x2a,			// Device id (Family)
		0xe1,			// Device unique id
		-1,			// Device revision (-1 = any match
		0x10000,			// Flash Size (Marketing number)
		1024,			// Flash Sector Size
		8192,			// XRAM Size
		...
		-1,			// Write lock
		0xffff,			// Single lock
		0x10000,			// Reserved Flash bottom addr
		-1,			// Reserved Flash top addr
		TRUE,			// Has flash scratchpad (SFLE)
		0x0000,			// Scratch start addr (SFLE=1)
		0x0400,			// Scratchpad length (bytes)
